...
- If the draft is empty, output one concise default system prompt in English suitable for a helpful, brief assistant.`,
  ...
  'chat.dialog.searchAria': 'Search chats',
  'chat.dialog.searchPlaceholder': 'Search by title…',
  'chat.dialog.searchNoResults': 'No chats match your search.',
  'chat.dialog.summaryBackToList': 'Back to chat list',
  'chat.send': 'Send',
...
- Si el borrador está vacío, devolvé un prompt de sistema breve por defecto en español, adecuado para un asistente útil y conciso.`,
  ...
  'chat.dialog.searchAria': 'Buscar chats',
  'chat.dialog.searchPlaceholder': 'Buscar por título…',
  'chat.dialog.searchNoResults': 'Ningún chat coincide con la búsqueda.',
  'chat.dialog.summaryBackToList': 'Volver a la lista de chats',
  'chat.send': 'Enviar',
